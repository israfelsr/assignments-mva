...
def main():
    ...
    train_gen = GraphProteinDataset(adj_train, features_train, labels_train)
    val_gen = GraphProteinDataset(adj_val, features_val, labels_val)
    ...
    # Create Model
    model = GraphNeuralNetwork(input_dim=n_input,
                               dropout=dropout,
                               output_dim=n_class,
