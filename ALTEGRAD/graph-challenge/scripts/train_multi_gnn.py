...
def main():
    ...
    adj_train, features_train, adjd_train, _, labels_train = train_set
    adj_val, features_val, adjd_val, _, labels_val = val_set

    train_gen = GraphProteinDataset(adj_train, features_train, adjd_train,
                                    labels_train)
    val_gen = GraphProteinDataset(adj_val, features_val, adjd_val, labels_val)
